...
CREATE TABLE Empresa (
  ...
  registro_Tributario VARCHAR(100),
  direccion_Social VARCHAR(100),
  correo_Cooperativo VARCHAR(100);
  id_Usuario INT,
...
CREATE TABLE Validacion_Empresa (
  id_Validacion INT AUTO_INCREMENT,
  id_Empresa INT,
  estado_Validacion VARCHAR(100) DEFAULT 'Pendiente',
  fecha_Validacion DATE DEFAULT NOW(), 
  comentarios TEXT,
